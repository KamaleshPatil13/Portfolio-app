  ...
  return (
    <section id="contact" className="pb-16 pt-16 justify-center flex">
      <div className="container">
        ...
        <div className="md:flex justify-between items-center md:space-x-6 lg: mx-0 sm: mx-[10px]">
          ...
          <div className="w-full md:w-1/2 lg:flex items-center bg-indigo-100 px-4 lg:px-8 py-8 rounded-[5px] h-[450px] ">
